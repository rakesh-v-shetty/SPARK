...
public class MonthlyLoadMapper extends Mapper<LongWritable, Text, Text, Text> {
    ...
    private static final int LOAD_ACTUAL_COLUMN = 24;
    ...
    public void map(LongWritable key, Text value, Context context) 
        ...
        try {
            ...
            String monthlyKey = String.format("%d-%02d", dateTime.getYear(), dateTime.getMonthValue());
            ...
            context.write(new Text(monthlyKey), new Text(loadValue));
